...
PFJet makeJet(std::vector<l1t::PFCandidate> parts){
    ...
    std::transform(parts.begin(), parts.end(), pt_deta.begin(), [&seed](const l1t::PFCandidate &part){
    ...
    std::transform(parts.begin(), parts.end(), pt_dphi.begin(), [&seed](const l1t::PFCandidate &part){
